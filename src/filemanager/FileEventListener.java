...
/**
 * Code sourced from Hive2Hive client on GitHub. Available at
 * https://github.com/Hive2Hive/Hive2Hive/tree/master/org.hive2hive.client/src/main/java/org/hive2hive/client/util
...
public class FileEventListener implements IFileEventListener {
  ...
  /**
   * This method provides a single point to change PERSYST handling of file
   * updates. If sending them through the Central Processor module is necessary,
   * this is where to change them. There are no other spots that would make
   * sense to change.
   * 
   * @param file
   *          The file to create the sync (download) process for
   * 
   * @author Andrew
   */
  private void downloadProcessPersystWrapper(File file)
