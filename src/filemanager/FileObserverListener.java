 ...
 * 
 * Default implementation of a file observer listener. The file events are
 * caught and the according process is automatically started.
 * 
 * @author Christian
 * 
 */
public class FileObserverListener implements FileAlterationListener {
  ...
  public void onStart(FileAlterationObserver observer) {
    // logger.debug("File observer for '{}' has been started.",
    // observer.getDirectory().toPath());
  }
  ...
  public void onStop(FileAlterationObserver observer) {
    // logger.debug("File observer for '{}' has been stopped.",
    // observer.getDirectory().toPath()));
  }
