 ...
 * configurations/user profile file. It uses the H2H EncryptionUtil to ensure
 * consistency in encryption throughout PERSYST.
 * 
 * It only supports AES Note that the initialization vector does NOT need to be
 * kept secret.
 * 
 * @author Andrew
 */
public final class PersystEncryption {
  ...
  /**
   * Decrypts data using the user's password and pin. Returns empty byte[] for
   * incorrect password/pin combination.
   * 
   * @param data
   *          A byte array of unencrypted data to be encrypted
   * @param initVector
   *          A vector used to begin encryption.
   * @param password
   *          The user's password
   * @param pin
   *          The user's pin
   ...
   * 
   * @param data
   *          A byte array of encrypted data to be decrypted
   * @param initVector
   *          A vector used to begin decryption.
   * @param password
   *          The user's password
   * @param pin
   *          The user's pin
  ...
  /**
   * Encrypts data using the specified key Be sure to store the initVector in
   * unencrypted form when calling this.
   * 
   * @param data
   *          A byte array of unencrypted data to be encrypted
   * @param initVector
  ...
  /**
   * Decrypts data using the specified key Returns empty byte[] for incorrect
   * password/pin combination.
   * 
   * @param data
   *          A byte array of encrypted data to be decrypted
   * @param initVector
