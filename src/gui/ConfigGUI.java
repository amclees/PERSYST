...
public class ConfigGUI {
  ...
  private void populateRoot(VBox root, Stage stage) {
    // Spacer add space between the label on the left and the button or text
    // field on the right
    ...
    // portField.setPromptText( (String)
    // PERSYSTSession.usr.getConfiguration("port"));
    ...
    maxSizeField.textProperty().addListener(new ChangeListener<String>() {
      ...
      public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        if (newValue.matches("\\d*")) {
          ...
          // PERSYSTSession.comm.setConfiguration("maxfilesize",
