...
public class NetworkView extends VBox {
  ...
  private void addComputer(String ipAddress) {
    ...
    Label label = new Label(hostname,
        new ImageView(new Image(getClass().getResourceAsStream("/images/computer_icon.png"))));
  ...
  // code from:
  // http://javafxforbeginners.blogspot.com/2015/08/javafx-validating-text-field-with-ip.html
