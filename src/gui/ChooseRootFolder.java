...
public class ChooseRootFolder {
  ...
  /**
   * Use this if you want to change the root folder. This class will update the
   * root folder
   */
  private void chooseRoot() {
    ...
    // Checks if a root has been selected otherwise it defaults to user.home or
    // C:/
    ...
    // System.out.println("after set root comint: " +
    // comint.getRootFolder().toString());
  }
